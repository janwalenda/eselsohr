    ...
    try {
      ...
      if (isCollectivesWriteAuthError(error)) {
        ...
        throw createError({
          statusCode: 401,
          statusMessage:
            "Diese Nextcloud-Verbindung kann keine Collectives-Seiten erstellen. Bitte verbinde Eselsohr mit einem manuellen App-Passwort erneut.",
        });
      }
