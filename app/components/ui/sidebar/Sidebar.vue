...
<template>
  <div
    ...
    data-slot="sidebar"
    :class="cn('bg-sidebar text-sidebar-foreground flex h-full w-sidebar flex-col', props.class)"
    v-bind="$attrs"
  >
    <slot />
  </div>
  ...
  <Sheet v-else-if="isMobile" :open="openMobile" v-bind="$attrs" @update:open="setOpenMobile">
    <SheetContent
      ...
      data-mobile="true"
      :side="side"
      class="bg-sidebar text-sidebar-foreground w-sidebar p-0 [&>button]:hidden"
      :style="{
  ...
  >
    ...
    <div
      :class="cn(
        'relative w-sidebar bg-transparent transition-[width] duration-200 ease-linear',
